...
<div class="admin-container">
  <div class="admin-header">
    <div>
      ...
      <p>Monitor and verify final payment proofs</p>
    </div>
  </div>
  ...
  <div class="filters-section">
    <form method="GET" class="filters-form">
      ...
      <a href="{{ route('admin.final-payments.index') }}" class="btn-reset">Reset</a>
    </form>
  </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            @php
              ...
              $shortName = $categoryMap[$payment->finalQualifier->competition_category] ?? 'Unknown';
            @endphp
          ...
          <td>
            <div class="action-buttons">
              <a href="{{ route('admin.final-payments.view', $payment) }}" target="_blank" class="btn-action btn-view" title="View Payment Proof">
              ...
              <form action="{{ route('admin.final-payments.verify', $payment) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to verify this payment? The team will be able to upload final submissions.')">
                @csrf
                @method('PATCH')
        ...
        <tr>
          <td colspan="6" style="text-align: center; padding: 2rem;">
            <p style="color: #6b7280;">No final payments found</p>
          </td>
        </tr>
        @endforelse
      </tbody>
...
function showRejectModal(paymentId) {
  ...
  form.action = `/admin/final-payments/${paymentId}/reject`;
